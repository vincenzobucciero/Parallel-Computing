...
int main() {
    ...
    */
    ...
    for ( i = 1; i <= n; i++)
    {
        ...
        /**
         * il costrutto critical forza l’esecuzione del blocco successivo ad un
         * thread alla volta (come farlo in sequenziale): è utile per gestire le .regioni critiche
        */
        #pragma omp critical
        sum = sum + f;
    }
